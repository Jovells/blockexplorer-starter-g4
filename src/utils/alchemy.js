...
export const getBalance = (address) => {
    const balance = alchemy.core.getBalance(address, "latest").then((bal) => bal)
    return balance
}

const getTxnByAddress = (address) => {
    const balance = alchemy.core.getAssetTransfers({
        fromBlock: "0x0",
        toAddress: (address),
        category: ["erc20"],
    })
...
export { getAllTxns, getTxnByAddress }