  ...
  return <Grid2 container>
      <Grid2 xs={6}>
       <Typography> Latest Blocks</Typography>
        {last10Blocks.map((block, i) => <Stack flexWrap={"unset"} width={1} key={block.number} alignContent={'space-between'} direction={"row"}>
              <Stack direction={'row'}>
      ...
      {last10Blocks[0]?.transactions.map((txn, i) => <Box width={1} key={txn.hash}>
